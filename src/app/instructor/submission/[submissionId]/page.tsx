...
export default function SubmissionReportParams({ params }: { params: Promise<{ submissionId: string }> }) {
    const { submissionId } = use(params);
    return <SubmissionReport submissionId={submissionId} />
}

function SubmissionReport({ submissionId }: { submissionId: string }) {
