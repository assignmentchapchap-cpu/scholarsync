...
import { UnifiedFAQ } from "@/components/how-it-works/UnifiedFAQ";
    ...
    return (
        <div className="pb-24">
            ...
            <SectionGrid>
                {/* Instructors */}
                <GridColumn span={4}>
                    <Link href="/how-it-works/instructors" className="block group h-full">
                ...
                {/* Colleges */}
                <GridColumn span={4}>
                    <Link href="/how-it-works/colleges" className="block group h-full">
                ...
                {/* TVET */}
                <GridColumn span={4}>
                    <Link href="/how-it-works/tvet" className="block group h-full">
                ...
                {/* Universities */}
                <GridColumn span={6}>
                    <Link href="/how-it-works/universities" className="block group h-full">
                ...
                {/* Students */}
                <GridColumn span={6}>
                    <Link href="/how-it-works/students" className="block group h-full">
