        ...
        <div className="w-full">
            <div className="flex flex-col gap-8 items-center">
                ...
                <div className="w-full max-w-4xl mx-auto text-center md:text-left">
                    <div className="flex flex-col md:flex-row gap-8 items-start">
                        <div className="flex-1">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-900/30 border border-indigo-500/30 text-indigo-300 text-xs font-bold uppercase tracking-widest mb-4">
                ...
                <div className="w-full relative animate-fade-in-up">
                    {/* Abstract Glow */}
                    <div className="absolute inset-0 bg-indigo-500/10 blur-3xl transform -rotate-1 rounded-3xl"></div>
